...
class Instamojo {
        ...
        function __construct(){
        	log_message('debug', "Instamojo Class Initialized.");
        	$this->_ci =& get_instance();
        	$this->_ci->load->config('instamojo');

        	$this->api_key = (string) $this->_ci->config->item('api_key');
            ...
            {
                $temp_error_msg .= 'You need to set your api key in the config file <br />';
            }
